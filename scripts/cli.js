...
const contractABI = require("../artifacts/contracts/Rippleledger.sol/Rippleledger.json").abi;

program
    .name("rippleledger-cli")
    .description("CLI tool for Rippleledger smart contract")
    .version("1.0.0");
